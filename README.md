...
| `nba_analytics.py`               | Core analytics logic, modeling, and hybrid data-fetching. Includes Bayesian Star Tax, late-scratch detection, and spread prediction. Falls back to cache or baseline if needed. |
