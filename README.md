...
4. **Logging and Tracking**
   ...
   - You'll be prompted for **Sportsbook**, **Odds**, and **Bet amount** (all optional — press Enter to skip).
...
| `Payout` | `95.45`, `-50`, etc.                 | Auto-calculated from Bet/Odds on WIN/LOSS             |
...
- **Pro-Level Verdict** — 5-point checklist:
