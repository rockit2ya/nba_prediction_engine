...
1. **Update and Fetch Real-Time Data**
   ...
   - For a manual refresh, run `bash fetch_all_data.sh` to update all caches.

2. **Analyze Games and Generate Recommendations**
   - The UI displays today’s NBA schedule.
...
- **edge_threshold_analysis.py**
  - Analyze win rates at different edge thresholds to tune your model’s recommendation cutoff.
