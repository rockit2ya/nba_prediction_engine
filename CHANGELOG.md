...
CLV was always calculated as `closing - market`, which is correct for AWAY picks but inverted for HOME picks. A bettor taking HOME -5.5 who sees the line close at -7.0 should have *positive* CLV (they got fewer points to give), but the old formula returned negative.
